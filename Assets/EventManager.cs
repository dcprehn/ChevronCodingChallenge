...
public class EventManager : MonoBehaviour
{
    ...
    {
        events = new();
        events.Add(new EnergyGameEvent("2024-02-25 00:00:00", EnergyType.Coal, -60f, 0f, "US"));
        events.Add(new EnergyGameEvent("2024-02-25 00:00:00", EnergyType.Coal, -45f, 0f, "US"));
        events.Add(new EnergyGameEvent("2024-02-25 00:00:00", EnergyType.Coal, -30f, 0f, "US"));
        events.Add(new EnergyGameEvent("2024-02-25 00:00:00", EnergyType.Coal, -15f, 0f, "US"));
        events.Add(new EnergyGameEvent("2024-02-25 00:00:00", EnergyType.Coal, 0f, 0f, "US"));
        events.Add(new EnergyGameEvent("2024-02-25 00:00:00", EnergyType.Coal, 15f, 0f, "US"));
        events.Add(new EnergyGameEvent("2024-02-25 00:00:00", EnergyType.Coal, 30f, 0f, "US"));
        events.Add(new EnergyGameEvent("2024-02-25 00:00:00", EnergyType.Coal, 45f, 0f, "US"));
        events.Add(new EnergyGameEvent("2024-02-25 00:00:00", EnergyType.Coal, 60f, 0f, "US"));
