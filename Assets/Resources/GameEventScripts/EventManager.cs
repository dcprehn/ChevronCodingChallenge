...
public class EventManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        events.Add(new EnergyGameEvent("2024-06-07 00:00:00", EnergyType.Wind, 43.5811f, -95.7758f, "United States of America"));
        ...
        events.Add(new EnergyGameEvent("2024-10-30 00:00:00", EnergyType.Solar, 28.1839f, 73.2407f, "India"));
        //Red marker in CHN turns into green bubble
        events.Add(new EnergyGameEvent("2024-11-15 00:00:00", EnergyType.Solar, 32.1944f, 119.6998f, "China"));
        events.Add(new InfoGameEvent("2024-11-16 00:00:00", "Looks like one of the red bubbles turned green! This can happen by targeting red dots in specific regions with technologies that are more efficient in those regions."));
        ...
        events.Add(new EnergyGameEvent("2025-01-12 00:00:00", EnergyType.Wind, 36.4725f, -101.3278f, "United States of America"));
        events.Add(new EnergyGameEvent("2025-01-28 00:00:00", EnergyType.Wind, 47.0053f, -96.4356f, "United States of America"));
        events.Add(new EnergyGameEvent("2025-02-14 00:00:00", EnergyType.Solar, 41.0930f, -73.9828f, "United States of America"));
        events.Add(new EnergyGameEvent("2025-01-30 00:00:00", EnergyType.Solar, 35.4273f, -79.1263f, "United States of America"));
        //4 GBR green bubbles appear
        events.Add(new EnergyGameEvent("2025-01-11 00:00:00", EnergyType.Solar, 53.2062f, -1.1968f, "United Kingdom"));
        events.Add(new EnergyGameEvent("2025-01-25 00:00:00", EnergyType.Solar, 51.8992f, -4.8665f, "United Kingdom"));
        events.Add(new EnergyGameEvent("2025-02-16 00:00:00", EnergyType.Solar, 52.4193f, -0.2366f, "United Kingdom"));
        events.Add(new EnergyGameEvent("2025-03-03 00:00:00", EnergyType.Solar, 51.3187f, 0.9029f, "United Kingdom"));
        //4 IND green bubbles appear
        events.Add(new EnergyGameEvent("2025-02-08 00:00:00", EnergyType.Solar, 26.8278f, 70.9197f, "India"));
        ...
        events.Add(new EnergyGameEvent("2025-05-10 00:00:00", EnergyType.Wind, 42.4489f, -99.8917f, "United States of America"));
        events.Add(new EnergyGameEvent("2025-05-22 00:00:00", EnergyType.Solar, 36.1971f, -80.8067f, "United States of America"));
        events.Add(new EnergyGameEvent("2025-05-30 00:00:00", EnergyType.Solar, 40.2003f, -74.5761f, "United States of America"));
        events.Add(new EnergyGameEvent("2025-06-12 00:00:00", EnergyType.Solar, 42.0761f, -71.4227f, "United States of America"));
        events.Add(new EnergyGameEvent("2025-06-30 00:00:00", EnergyType.Solar, 33.7943f, -118.2414f, "United States of America"));
        events.Add(new EnergyGameEvent("2025-07-11 00:00:00", EnergyType.Solar, 41.5358f, -73.3913f, "United States of America"));
        events.Add(new EnergyGameEvent("2025-07-26 00:00:00", EnergyType.Hydro, 44.5281f, -121.1528f, "United States of America"));
        events.Add(new EnergyGameEvent("2025-08-13 00:00:00", EnergyType.Hydro, 35.0314f, -81.4936f, "United States of America"));
        events.Add(new EnergyGameEvent("2025-08-29 00:00:00", EnergyType.Hydro, 37.1510f, -119.5047f, "United States of America"));
        ...
        //5 Green bubbles appear in US
        events.Add(new EnergyGameEvent("2026-05-02 00:00:00", EnergyType.Solar, 44.4777f, -73.1534f, "United States of America"));
        events.Add(new EnergyGameEvent("2026-05-23 00:00:00", EnergyType.Solar, 40.5161f, -74.3400f, "United States of America"));
        events.Add(new EnergyGameEvent("2026-06-08 00:00:00", EnergyType.Solar, 42.1091f, -72.1712f, "United States of America"));
        events.Add(new EnergyGameEvent("2026-06-30 00:00:00", EnergyType.Hydro, 29.5940f, -98.0407f, "United States of America"));
        ...
        events.Add(new EnergyGameEvent("2026-08-02 00:00:00", EnergyType.Wind, 41.8559f, -1.9224f, "Spain"));
        events.Add(new EnergyGameEvent("2026-08-02 00:00:00", EnergyType.Hydro, 60.8648f, 9.2790f, "Norway"));
        events.Add(new EnergyGameEvent("2026-08-02 00:00:00", EnergyType.Hydro, 48.7872f, 2.4033f, "France")); //same as red marker
        events.Add(new EnergyGameEvent("2026-08-02 00:00:00", EnergyType.Wind, 54.5000f, 7.7999f, "Germany"));
        events.Add(new EnergyGameEvent("2026-08-02 00:00:00", EnergyType.Hydro, 41.9547f, 14.3884f, "Italy"));
        //5 green bubbles in USA
        events.Add(new EnergyGameEvent("2026-09-08 00:00:00", EnergyType.Hydro, 42.9506f, -85.4859f, "United States of America"));
        events.Add(new EnergyGameEvent("2026-09-30 00:00:00", EnergyType.Hydro, 34.8158f, -118.6867f, "United States of America"));
        events.Add(new EnergyGameEvent("2026-10-30 00:00:00", EnergyType.Hydro, 48.1802f, -116.9986f, "United States of America"));
        events.Add(new EnergyGameEvent("2026-11-30 00:00:00", EnergyType.Hydro, 44.5620f, -83.8045f, "United States of America"));
        events.Add(new EnergyGameEvent("2026-12-12 00:00:00", EnergyType.Hydro, 42.5484f, -106.7175f, "United States of America"));
        //5 green bubbles in Iceland
        events.Add(new EnergyGameEvent("2026-10-07 00:00:00", EnergyType.Geothermal, 64.0373f, -21.4007f, "Iceland"));
        events.Add(new EnergyGameEvent("2026-10-26 00:00:00", EnergyType.Geothermal, 65.7035f, -15.7735f, "Iceland"));
        events.Add(new EnergyGameEvent("2026-11-07 00:00:00", EnergyType.Geothermal, 65.1081f, -21.2567f, "Iceland"));
        events.Add(new EnergyGameEvent("2026-11-30 00:00:00", EnergyType.Geothermal, 63.8251f, -22.6848f, "Iceland"));
        events.Add(new EnergyGameEvent("2026-12-24 00:00:00", EnergyType.Geothermal, 64.8788f, -21.4332f, "Iceland"));
        //5 green bubbles appear in China
        events.Add(new EnergyGameEvent("2026-08-03 00:00:00", EnergyType.Hydro, 30.4837f, 101.6032f, "China"));
        events.Add(new EnergyGameEvent("2026-09-10 00:00:00", EnergyType.Hydro, 27.3488f, 100.5061f, "China"));
        events.Add(new EnergyGameEvent("2026-11-22 00:00:00", EnergyType.Hydro, 32.0400f, 102.5700f, "China"));
        events.Add(new EnergyGameEvent("2026-12-18 00:00:00", EnergyType.Hydro, 26.6661f, 106.1219f, "China"));
        events.Add(new EnergyGameEvent("2027-01-06 00:00:00", EnergyType.Wind, 43.3500f, 115.9000f, "China"));
        events.Add(new InfoGameEvent("2027-02-25 00:00:00", "The world is going green! Keep upgrading your technologies and combating climate change one day at a time!"));
    }
